...
/* Whether an entry is a generated render artifact is a question about WHERE it lives, not what it
   is called — see `isPreviewArtifact` and the layout contract in ./artifactLayout. */
