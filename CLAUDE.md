...
- **Cloudflare Stream** (planned, see `CLAUDE_CODE_PROMPT_video-stream.md`) = video playback + thumbnails/animated previews. Keyed to folder identity via `stream_uid`. R2 keeps the master; Stream is added alongside, not instead.
